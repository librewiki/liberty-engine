...
class Article extends LibertyModel {
   ...
   * @static
   */
  static async findByFullTitleWithRedirection(fullTitle) {
    const { namespace, title } = models.Namespace.splitFullTitle(fullTitle);
   ...
   * @static
   */
  static async existsWithRedirection(fullTitle) {
    return !!await this.findByFullTitleWithRedirection(fullTitle);
  }
